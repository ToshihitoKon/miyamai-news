...
class LastFetchStore
  ...
  def rollback!
    ...
    write(data.merge("pending_at" => nil, "rollback_at" => data["pending_at"], "last_op" => "discard"))
  end
  ...
  def restore!
    ...
    when "discard"
      write(data.merge("pending_at" => data["rollback_at"], "rollback_at" => nil, "last_op" => nil))
    end
  end
  ...
  def confirm_immediately!(at:)
    write(load.merge("confirmed_at" => at.iso8601, "pending_at" => nil, "rollback_at" => nil, "last_op" => nil))
  end
